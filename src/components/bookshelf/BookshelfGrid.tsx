          ...
          return (
            ...
            >
              <div className="absolute right-1 top-1 z-50 opacity-0 group-hover:opacity-100 transition-opacity">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline" size="icon" className="h-7 w-7 bg-white rounded-md border border-gray-200">
              ...
              <div className="relative">
                ...
                {book.isSeries && (
                  <Badge className="absolute top-2 left-2 bg-gray-900 text-white text-xs">Series</Badge>
                )}
              </div>
              ...
              <div className="mt-2 text-center">
                ...
                {book.recommendedBy && (
                  <div className="text-xs text-center mt-1 text-gray-700 break-words max-w-full">
